...
The point isn't to find more jobs. It's to spend your evening on the three roles that matter instead of the fifty that don't.
...
It's not a bigger firehose, and it's not an auto-applier. It's a filter with taste, tuned by you and getting sharper each time you correct it.
